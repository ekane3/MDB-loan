...
<ul id="slide-out" class="side-nav custom-scrollbar sn-bg-4">
  ...
  <li>
    ...
    <ul class="collapsible collapsible-accordion">
        ...
        <div class="collapsible-body">
          ...
          <ul>
            ...
            <li>
              ...
              <a href="cart-v1.php" class="waves-effect">Cart V.1</a>
        ...
        <div class="collapsible-body">
          ...
          <ul>
            ...
            <li>
              ...
              <a href="homepage-v1.php" class="waves-effect">Homepage V.1</a>

            </li>

            <li>

              <a href="homepage-v2.html" class="waves-effect">Homepage V.2</a>

            </li>

            <li>

              <a href="homepage-v3.html" class="waves-effect">Homepage V.3</a>
        ...
        <div class="collapsible-body">
          ...
          <ul>
            ...
            <li>
              ...
              <a href="product-v1.html" class="waves-effect">Product V.1</a>

            </li>

            <li>

              <a href="product-v2.html" class="waves-effect">Product V.2</a>
      ...
      <li>
        <a href="contact.html" class="collapsible-header waves-effect">
          <i class="fas fa-barcode"></i> Dashboard
        </a>
      </li>
      <li>
        <a href="materiels.php" class="collapsible-header waves-effect">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item ml-3">
          ...
          <a class="nav-link waves-effect waves-light dark-grey-text font-weight-bold" href="#">
            ...
            <i class="fas fa-cog blue-text"></i> Dashboard</a>
